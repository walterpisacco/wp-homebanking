...
if(localStorage.getItem("lang") =='br'){
  var locale = 'br';
  messageDel = "Tem certeza de que deseja excluir?";
  messageSave = "Tem certeza que deseja salvar?";
  messageClear = "Tem certeza que quer limpar?";
}
